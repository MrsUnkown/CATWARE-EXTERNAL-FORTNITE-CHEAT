...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* v, const void* v_min, const void* v_max, const char* format, float power)
{
    ...
    // Render grab
    window->DrawList->AddRectFilled(ImVec2(frame_bb.Min.x + 1, frame_bb.Min.y + 3.25), ImVec2(grab_bb.Max.x - 3, grab_bb.Max.y), ImColor(255, 0, 11, 255), style.GrabRounding);
